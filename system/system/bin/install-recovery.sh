#!/system/bin/sh
if ! applypatch --check EMMC:/dev/block/bootdevice/by-name/recovery:82825216:6247cc81a8d215f04a78347a94f1269a144b402e; then
  applypatch \
          --patch /system/recovery-from-boot.p \
          --source EMMC:/dev/block/bootdevice/by-name/boot:67108864:ceb6a784a9fa80ed81d1007172cc76027ad1d256 \
          --target EMMC:/dev/block/bootdevice/by-name/recovery:82825216:6247cc81a8d215f04a78347a94f1269a144b402e && \
